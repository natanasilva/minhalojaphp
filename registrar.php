                        ...
                        <div class="col-6 offset-3">
                            <div class="card-body login-card-body">
                                ...
                                <form action="cadastro.php" method="post">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="text" name="enderecoUsuario" class="form-control" placeholder="Seu endereço">
                                        <div class="input-group-append">
                                            <div class="input-group-text">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="email" name="emailUsuario" class="form-control" placeholder="Seu Email">
                                        <div class="input-group-append">
                                            <div class="input-group-text">
                                    ...
                                    <div class="input-group mb-3">
                                        <input type="password" name="senhaUsuario" class="form-control" placeholder="Sua senha">
                                        <div class="input-group-append">
                                            <div class="input-group-text">
                                    ...
                                    <div class="input-group mb-3">
                                        <?php $hoje = date('d/m/Y'); ?>
                                        <input type="text" name="dataCadastroUsuario" class="form-control" value="<?= $hoje; ?>" hidden>
                                    </div>
                                    <div class="row">
                                        <div class="col-8">
                                ...
                                <p class="mb-0">
                                    <a href="minha_conta.php" class="text-center">Ja tem conta? Fazer Login</a>
                                </p>
                            </div>
                            <!-- /.login-card-body -->
